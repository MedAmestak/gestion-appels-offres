...
router.post('/', async (req, res) => {
    try {
      const { Type_Appel_Offre, Titre, Expression_Besoin, Date_Creation_Appel_Offre, Date_Validation_Appel_Offre, Date_Publication, Date_Ouverture_Plis, Statut_Appel_Offre, Statut_Approbation, User } = req.body;
...
router.get('/', async (req, res) => {
  try {
    const appelsOffres = await AppelOffre.find().populate('User', 'username');;
